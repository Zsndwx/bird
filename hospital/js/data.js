...
<a href='#'><img src='{imgurl}' class='pic'></a>
<div class='detail'>
	<a href='#' class='name'>{name} <span class='level'>{level}</span></a>
	<span class='time'>放号时间：{time}</span>
	<span class='call'>{call}</span>
	<span class='address'>{address}</span>
	<a href='#' class='link'><span class='circle'>+</span>现在预约</a>
</div>
</div>
`
