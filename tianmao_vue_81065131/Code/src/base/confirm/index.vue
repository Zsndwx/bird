    ...
    <div class="mine-confirm-wrapper" v-show="visible">
      <div class="mine-confirm">
        ...
        <div class="mine-confirm-btns">
          <button @click="cancel" class="mine-confirm-btn mine-confirm-cancel">{{cancelBtnText}}</button>
          <button @click="confirm" class="mine-confirm-btn mine-confirm-ok">{{confirmBrnText}}</button>
        </div>
      </div>
    </div>
  </transition>
